...
train_ds = tf.data.Dataset.from_generator(
    ...
    output_signature=(tf.TensorSpec(shape=(None, 260, 260, 3), dtype=tf.float32),  #CHANGE RESOLUTION BASED ON MODEL
...
plot_hist(hist)
model.save_weights("/home/jordan/modelV1B2GSMOTE.weights.h5")
