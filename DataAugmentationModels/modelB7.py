...
img_augmentation_layers = [
    ...
    # layers.RandomBrightness(factor=0.2)  having it on lowers accuracy by 0.8%
]
...
plot_hist(hist)
model.save_weights("/home/jordan/modelV1B7dataAug.weights.h5")
model.evaluate(test_ds)
model.load_weights("/home/jordan/modelV1B7dataAug.weights.h5")
model.evaluate(test_ds)
